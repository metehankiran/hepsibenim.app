            ...
            <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                        ...
                        <li class="breadcrumb-item text-nowrap active">{{ $category->title }}
                        </li>
                    </ol>
                </nav>
            </div>
                        ...
                        <div class="widget widget-categories mb-4 pb-4 border-bottom">
                            ...
                            <div class="accordion mt-n1" id="shop-categories">
                                ...
                                <div class="accordion-item">
                                    <h3 class="accordion-header"><a style="font-size:1rem;letter-space:1rem;font-weight:{{ (request()->segment(2) == $category->slug) ? '600' : '200' }}" class="active" href="{{ route('category',$category) }}">{{ $category->title }} - ({{ $category->products->where('is_active',true)->count() }} ürün)</a></h3>
                                </div>
                                @endforeach
                            </div>
                        </div>
                ...
                @foreach ($products->where('is_active',true) as $product)
                    ...
                    <div class="col-md-4 col-sm-6 px-2 mb-4">
                        <div class="card product-card">
                            ...
                            <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">{{ $product->category->title }}</a>
